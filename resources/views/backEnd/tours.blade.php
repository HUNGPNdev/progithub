									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a href="{{asset('admin/tours/delete/'.$tour->tour_id)}}" onclick="return confirm('Do you sure delete')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Xóa</a><br><br>
											</td>
										</tr>
										@endforeach
									</tbody>
