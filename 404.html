            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="for-img wow fadeIn" data-wow-duration="2.5s">
                        <img src="assets/img/common-img/for.png" alt="img">
                    </div>
                    <div class="for-text-btn">
                        <h4>LOOKS LIKE YOU LOST YOUR WAY HOME</h4>
                    </div>
                    <div class="for-btn">
                        <a href="index-2.html" class="btn for-pag-btn">Go TO HOME PAGE</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="recent-fot-post mar-top-responsive">
                        ...
                        <div class="post-cover-foot">
                            <div class="pos-rece-1">
                                <div class="post-rect-img">
                                    <a href="blog-single.html">
                                        <img src="assets/img/common-img/footer-blog.png"
                                        alt="" />
                                    </a>
                                </div>
                            ...
                            <div class="pos-rece-1">
                                <div class="post-rect-img">
                                    <a href="blog-single.html">
                                        <img src="assets/img/common-img/footer-blog-1.png"
                                        alt="" />
                                    </a>
                                </div>
                                <div class="podt-text-1">
                            ...
                            <div class="pos-rece-1">
                                <div class="post-rect-img">
                                    <a href="blog-single.html">
                                        <img src="assets/img/common-img/footer-blog-2.png"
                                        alt="" />
                                    </a>
                                </div>
                                <div class="podt-text-1">
